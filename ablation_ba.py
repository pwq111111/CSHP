...
def main():
    ...
    model = ppt_model.model_prompt_ba(args.batch_size,args.prompt_length, args.embedding_length, args.prompt_position, args.prompt_cls_length,
